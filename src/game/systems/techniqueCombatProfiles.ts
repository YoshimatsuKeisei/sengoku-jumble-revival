...
export const TECHNIQUE_COMBAT_PROFILES: Record<UnitTechnique, TechniqueCombatProfile> = {
  ...
  TEPPOU_SHOOTING: profile("projectile", 7, "PROJECTILE_SINGLE", 1, 1, 0, 1, SWF_RANGED_ACTION_TICKS, 0),
  TEPPOU_SNIPING: profile("projectile", 11, "PROJECTILE_SINGLE", 1, 1, 0, 1, SWF_RANGED_ACTION_TICKS, 0),
  TEPPOU_BOMBARDMENT: profile("projectile", 9, "PROJECTILE_IMPACT_RECTANGLE", 3, 3, 0, 1, SWF_RANGED_ACTION_TICKS, 0),
  ARCHER_ARROW: profile("projectile", 3, "PROJECTILE_SINGLE", 1, 1, 0, 1, SWF_RANGED_ACTION_TICKS, 0),
  ARCHER_LONG_SHOT: profile("projectile", 5, "PROJECTILE_SINGLE", 1, 1, 0, 1, SWF_RANGED_ACTION_TICKS, 0),
  ARCHER_FIRE_ARROW: profile("projectile", 3, "PROJECTILE_SINGLE", 1, 1, 0, 1, SWF_RANGED_ACTION_TICKS, 0),
  ARCHER_HOROKU: profile("projectile", 3, "PROJECTILE_IMPACT_RECTANGLE", 3, 3, 0, 1, SWF_RANGED_ACTION_TICKS, 0),
